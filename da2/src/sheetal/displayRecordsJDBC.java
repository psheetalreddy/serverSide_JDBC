...
@WebServlet("/displayRecordsJDBC")
public class displayRecordsJDBC extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<h1  style= 'text-align: center'><em><strong>Records in Employee Database</strong></em></h1><br><br>");
